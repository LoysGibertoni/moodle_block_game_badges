...
$string['criteria_descr_short7'] = 'Reach <strong>{$a}</strong> of: ';
...
$string['criteria_descr_single_short7'] = 'Reach: ';
...
$string['criteria_descr_single_7'] = 'The following achievement has to be reached:';
...
$string['criteria_descr_7'] = '<strong>{$a}</strong> of the following achievements have to be reached:';
...
$string['criteria_7'] = 'Achievement reaching';
$string['criteria_7_help'] = 'Allows a badge to be awarded to users for reaching a set of achievements. ';
